  ...
  return (
    <div className="w-screen h-fit bg-white flex justify-between p-20 font-mono border border-t-black">
      ...
      <div id="information" className="flex justify-evenly w-full">
        ...
        <div id="contact" className="flex flex-col space-y-2">
          <h2 className="font-bold text-lg">Contact Us</h2>
          <a href="wa.me/" className="flex items-center space-x-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div id="team" className="flex flex-col space-y-2">
          <h2 className="font-bold text-lg text-left">Team</h2>
          <Link to="/us" className="text-green-600">Agrobumi Indonesia</Link>
        </div>
      </div>
    </div>
  );
