    ...
    <div>
        ...
        <div className="container">
            ...
            <div className="card-container">
                <div className="card">
                    <img alt="Botanic1" height="150" src="https://images.pexels.com/photos/849403/pexels-photo-849403.jpeg" width="300"/>
                    ...
                    <div className="card">
                        <img alt="Botanic2" height="150" src="https://images.pexels.com/photos/1540330/pexels-photo-1540330.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" width="300"/>
                        <h3>Garden Party</h3>
                        <a>September</a>
                        <a>Location: Lombok</a>
                        <div className="details">
                    ...
                    <div className="card">
                        <img alt="Botanic3" height="150" src="https://images.pexels.com/photos/3036366/pexels-photo-3036366.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" width="300"/>
                        <h3>Cooking Class</h3>
                        <a>September</a>
                        <a>Location: Lombok</a>
                        <div className="details">
                    ...
                    <div className="card">
                        <img alt="Botanic4" height="150" src="https://images.pexels.com/photos/3036366/pexels-photo-3036366.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" width="300"/>
